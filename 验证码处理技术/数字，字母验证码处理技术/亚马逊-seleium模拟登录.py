...
driver.find_element_by_xpath("//input[@id='ap_email']").send_keys("nnnn") #利用xpath查找元素进行输入文本
...
driver.find_element_by_xpath("//input[@id='ap_password']").send_keys("******") #利用xpath查找元素进行输入文本
